...
def build_pre_move_prediction(
    ...
    return {
        ...
        "management": {
            ...
            "tp1": "TP1 es un hito de seguimiento; el SL estructural congelado no se mueve automáticamente a break-even.",
            "tp2": "Objetivo principal PAPER; mantener la gestión del plan congelado sin recalcular el stop.",
            "tp3": "Runner opcional solo si el plan original lo definió; nunca ampliar ni acercar automáticamente el SL estructural.",
            "time_stop": f"Si en ~{time_stop} min no hay seguimiento y no alcanzó al menos 0.5R, reevaluar/salir por tiempo sin deformar el SL.",
        },
