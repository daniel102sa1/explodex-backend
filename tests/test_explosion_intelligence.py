from app.services.explosion_intelligence import classify_horizons, timing_memory_adjustment
...
def test_memory_cannot_change_entry_before_thirty_cases():
    ...
    model = {
        "buckets": {
            "76-81": {
                "sample": 29,
                "fast_explosion_rate_pct": 90.0,
                "fake_breakout_rate_pct": 0.0,
                "direction_wrong_rate_pct": 0.0,
                "avg_short_favorable_r": 3.0,
                "avg_short_adverse_r": 0.2,
            }
        }
    }
...
def test_usable_memory_can_nudge_timing_but_only_by_small_amount():
    ...
    model = {
        "buckets": {
            "76-81": {
                "sample": 40,
                "fast_explosion_rate_pct": 62.0,
                "fake_breakout_rate_pct": 8.0,
                "direction_wrong_rate_pct": 10.0,
                "avg_short_favorable_r": 2.1,
                "avg_short_adverse_r": 0.7,
            }
        }
    }
    result = timing_memory_adjustment(ignition, model)
...
def test_bad_historical_bucket_penalizes_timing_instead_of_forcing_trade():
    ...
    model = {
        "buckets": {
            "82-87": {
                "sample": 55,
                "fast_explosion_rate_pct": 20.0,
                "fake_breakout_rate_pct": 31.0,
                "direction_wrong_rate_pct": 28.0,
                "avg_short_favorable_r": 0.6,
                "avg_short_adverse_r": 1.2,
            }
        }
    }
    result = timing_memory_adjustment(ignition, model)
